...
const ContactList = () => {
  ...
  const prueba = async () => {
    ...
    axios
      .get("http://192.168.1.89:8081/api/obtener/productos")
      .then((res) => {
      ...
      .catch((err) =>{ console.log("err", err); console.log("ayudaa");});
        ...
        /* return fetch('http://192.168.1.89:8081/api/obtener/productos')
  ...
  const editProduct = async () => {
    axios
      .post("http://192.168.1.89:8081/api/guardar/producto", {
        id: product.id,
